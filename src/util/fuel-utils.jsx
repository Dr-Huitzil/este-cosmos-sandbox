 ...
 *
 * IMPORTANT: allEntries must be pre-sorted newest-first by date to avoid
 * O(n log n) sorts on every function call, particularly during render loops.
 *
 * @param {{ odometer: number, fuelQuantity: number, isFull: boolean}} currentEntry
 * @param {Array<{ odometer: number, fuelQuantity: number, isFull: boolean, day: string}>} allEntries - newest first
 * @returns {numbers}
 */
