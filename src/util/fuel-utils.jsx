 ...
 *
 * IMPORTANT: allEntries must be pre-sorted newest-first by date/odometer
 * This avoids O(n log n) sorting on every call, preventing O(N^2 log N) degradation
 * when called within render loops or array iterations.
 *
