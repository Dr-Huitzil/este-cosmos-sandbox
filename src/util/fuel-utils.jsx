...
export function calculateMPG(currentEntry, allEntries) {
  ...
  // ⚡ Bolt Performance Optimization: Removed redundant array copying and internal sorting
  // It is the caller's responsibility to pass a pre-sorted array to prevent O(N^2 log N)
  // rendering performance degradation when this utility is called in table/chart render loops.
