 ...
 *
 * IMPORTANT: allEntries must be pre-sorted newest-first by day to avoid
 * O(n log n) sorts on every render.
 *
 * @param {{ odometer: number, fuelQuantity: number, isFull: boolean}} currentEntry
 * @param {Array<{ odometer: number, fuelQuantity: number, isFull: boolean, day: string}>} allEntries - pre-sorted newest-first
 * @returns {numbers}
 */
