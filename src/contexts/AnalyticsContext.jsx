...
export function AnalyticsProvider({ children }) {
  ...
  const fuelEfficiencyData = useMemo(
    () => {
      ...
      // ⚡ Bolt: sortedFuelEntries is pre-sorted newest-first, we use it directly for calculateMPG
      // The local 'sorted' array is sorted oldest-first for chart rendering
